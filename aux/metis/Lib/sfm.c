 ...
 * George
 *
 * $Id: sfm.c 1363 2004-07-24 13:35:24Z exa $
 *
 */
    ...
    *******************************************************/
    ...
    for (nswaps=0; nswaps<nvtxs; nswaps++) {
      ...
      if (u[0] != -1 && u[1] != -1) {
        ...
        if (pwgts[to]+vwgt[u[to]] + pwgts[2] > badmaxpwgt) /*BU*/
          to = (to+1)%2;
      }
      else if (u[0] == -1 && u[1] == -1) {
        break;
      }
      else if (u[0] != -1 && pwgts[0]+vwgt[u[0]] + pwgts[2] <= badmaxpwgt) {/*BU*/
        to = 0;
      }
      else if (u[1] != -1 && pwgts[1]+vwgt[u[1]] + pwgts[2]<= badmaxpwgt) {
        to = 1;
      }
      else
        break;
    ...
    *******************************************************/
    ...
    for (nswaps=0; nswaps<nvtxs; nswaps++) {
      ...
      if (u[0] != -1 && u[1] != -1) {
        ...
        if (pwgts[to]+vwgt[u[to]]+pwgts[2] > badmaxpwgt) 
          to = (to+1)%2;
      }
      else if (u[0] == -1 && u[1] == -1) {
        break;
      }
      else if (u[0] != -1 && pwgts[0]+vwgt[u[0]] + pwgts[2] <= badmaxpwgt) {
        to = 0;
      }
      else if (u[1] != -1 && pwgts[1]+vwgt[u[1]] + pwgts[2]<= badmaxpwgt) {
        to = 1;
  ...
  for (pass=0; pass<npasses; pass++) {
    ...
    *******************************************************/
    ...
    for (nswaps=0; nswaps<nvtxs; nswaps++) {
      ...
      if (pwgts[to]+vwgt[higain]+pwgts[2] > badmaxpwgt)
...
void FM_2WayNodeBalance(CtrlType *ctrl, GraphType *graph, float ubfactor)
{
  ...
  if (abs(pwgts[0]-pwgts[1]) < (int)((ubfactor-1.0)*(pwgts[0]+pwgts[1]+2*pwgts[2])))
  {
    /*return*/;
  }
