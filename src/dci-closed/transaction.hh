...
#ifndef __DCICLOSED_TRANSACTION_H
#define __DCICLOSED_TRANSACTION_H
...
template <class T> 
void prune_and_map_and_ord_first_iter(DCIClosed::Transaction<unsigned int>&, 
				      DCIClosed::Transaction<T>&, 
				      dci_items&);
...
template <class T> 
void prune_and_map_and_ord_first_iter(DCIClosed::Transaction<unsigned int>& t_in, 
				      DCIClosed::Transaction<T>& t_out, 
				      dci_items& ii)
{
  int j=0;
